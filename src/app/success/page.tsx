  ...
  return (
    <div className="text-center my-20">
      ...
      <p className="mt-10 font-montserrat text-xl md:text-3xl md:w-[680px] lg:w-[900px] mx-auto">
        Our team will reach out to you soon using the phone number or email address you provided, so
        keep an eye out. If you have any questions or concerns in the meantime, don’t hesitate to
