...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden mb-13">
      <div className="hidden absolute right-10 md:right-0 lg:right-0 2xl:right-7 top-80 lg:top-[330px] transform -translate-y-1/2 md:flex md:flex-col items-center text-center space-y-2 z-10">
        <div className="flex flex-col h-[45vh] md:space-y-7 lg:space-y-20">
          <h1 className="text-xl md:text-4xl lg:text-4xl xl:text-[65px] xl:leading-none 2xl:text-6xl font-bold z-10 text-darkblue text-center drop-shadow-custom">
            OXFORDSHIRE &<span className="block">BUCKINGHAMSHIRE</span>
          </h1>

          <h2 className="text-orange text-2xl md:text-3xl lg:text-4xl xl:text-[50px] xl:leading-none font-bold italic text-center drop-shadow-custom">
