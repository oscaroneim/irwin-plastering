...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden mb-12">
      <div className="hidden absolute right-10 md:right-7 top-80 lg:top-96 transform -translate-y-1/2 md:flex md:flex-col items-center text-center space-y-2 z-10">
        <div className="flex flex-col h-[50vh] md:space-y-7 lg:space-y-14">
          ...
          <div className="flex justify-center bottom-0 ">
            <Link href="/contact">
              <button className="bg-lightblue text-white font-bold lg:p-6 px-3 py-4 rounded-md drop-shadow-lg hover:bg-darkblue text-lg lg:text-xl">
                Submit an enquiry
              </button>
            </Link>
          </div>
      ...
      <div className="md:hidden absolute inset-0 flex flex-col items-center justify-center text-center z-10">
        ...
        <div className="left-[70px] bottom-12 md:hidden absolute">
          <Link href="/contact">
            <button className="bg-lightblue text-white font-bold lg:p-6 px-3 py-3 rounded-md drop-shadow-lg hover:bg-darkblue text-lg lg:text-xl">
              Submit an enquiry
            </button>
          </Link>
        </div>
